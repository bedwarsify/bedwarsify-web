    ...
    >
      ...
      >
        <div class="flex justify-between items-center">
          <h2 class="font-semibold text-xl">Download</h2>

          <button class="h7 w-7" @click="downloadModal = false">
            <svg
              class="h-7 w-7"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
        ...
        <div
          ...
          "
        >
          <template v-if="downloadModalView === 'DEFAULT'">
            <button
              class="
                flex
                md:flex-col
                ...
                focus:outline-none
              "
              @click="downloadModalView = 'WINDOWS'"
            >
              <svg
                class="w-6 h-6 md:w-12 md:h-12 fill-current text-gray-400"
                role="img"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
          ...
          <a
            v-if="downloadModalView === 'LINUX'"
            href="https://snapcraft.io/bedwarsify-overlay"
            class="
              flex
              md:flex-col
              rounded-xl
          ...
          <a
            v-if="downloadModalView === 'WINDOWS'"
            href="https://www.microsoft.com/store/productId/9P8H0C5QWZKH"
            class="
              flex
              md:flex-col
              rounded-xl
...
export default Vue.extend({
  data() {
    return {
      downloadModal: false,
      downloadModalView: 'DEFAULT' as 'DEFAULT' | 'WINDOWS' | 'MACOS' | 'LINUX',
      comparison: {
        alternatives: [
          'Bedwarsify Overlay',
          'BWStats Overlay',
